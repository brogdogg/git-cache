...
namespace git_cache.Services.mstest.Git
{
  ...
  public class LocalRepoUnitTest
  {
    ...
    public void ThrowsWhenRemoteRepositoryIsInvalid()
    {
      var localRepo =
        new LocalRepository(null,
                      Substitute.For<IGitCacheConfiguration>());
    ...
    public void ConstructsPathCorrectly()
    {
      ...
      var owner = "owner";
      var name = "name";
      var config = Substitute.For<IGitCacheConfiguration>();
      config.LocalStoragePath.Returns("/test");
      var remoteRepo = new RemoteRepository(server, owner, name, null);
    ...
    public void CreatesLocalDirectory()
    {
      ...
      var config = Substitute.For<IGitCacheConfiguration>();
      config.LocalStoragePath.Returns(basePath);
      var remoteRepo = new RemoteRepository(server, owner, name, null);
