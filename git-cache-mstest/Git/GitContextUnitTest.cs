...
namespace git_cache_mstest.Git
{
  ...
  public class GitContextUnitTest
  {
    ...
    {
      var t = new GitContext(null, m_remote, m_git, m_lfs);
    ...
    {
      var t = new GitContext(m_local, null, m_git, m_lfs);
    ...
    {
      var t = new GitContext(m_local, m_remote, null, m_lfs);
    ...
    {
      var t = new GitContext(m_local, m_remote, m_git, null);
    ...
    {
      var t = new GitContext(m_local, m_remote, m_git, m_lfs);
